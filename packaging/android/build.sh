...
${SUBSURFACE_SOURCE}/scripts/get-dep-lib.sh single . sqlite
...
${SUBSURFACE_SOURCE}/scripts/get-dep-lib.sh single . libxml2
pushd libxml2
autoreconf --install
popd
...
${SUBSURFACE_SOURCE}/scripts/get-dep-lib.sh single . libxslt
pushd libxslt
autoreconf --install
popd
...
${SUBSURFACE_SOURCE}/scripts/get-dep-lib.sh single . libzip
...
${SUBSURFACE_SOURCE}/scripts/get-dep-lib.sh single . openssl
...
${SUBSURFACE_SOURCE}/scripts/get-dep-lib.sh single . libgit2
...
${SUBSURFACE_SOURCE}/scripts/get-dep-lib.sh single . libusb
...
${SUBSURFACE_SOURCE}/scripts/get-dep-lib.sh single . libftdi1
